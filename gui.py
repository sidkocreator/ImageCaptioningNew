...
top.configure(background='#B9E9FC')
label2=Label(top,background='#B9E9FC', font=('arial',15))
label1=Label(top,background='#B9E9FC', font=('arial',15))
label=Label(top,background='#B9E9FC', font=('arial',15))
...
upload.configure(background='#FC2947', foreground='blue',font=('arial',10,'bold'))
upload.pack(side=BOTTOM,pady=50)
sign_image.pack(side=BOTTOM,expand=True)


#label2.pack(side = BOTTOM, expand = True)
heading = Label(top, text="Image Caption Generator (Flickr30k)",pady=20, font=('arial',22,'bold'))
heading.configure(background='#B9E9FC',foreground='#FF6347')
heading.pack()
top.mainloop()
